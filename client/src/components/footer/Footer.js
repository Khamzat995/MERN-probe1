            ...
            <div className="follow__container">
                ...
                <div>
                    <ul className="follow__list">
                        <li className="follow__icon"><i className="fab fa-facebook"/></li>
                        <li className="follow__icon"><i className="fab fa-twitter"/></li>
                        <li className="follow__icon"><i className="fab fa-invision"/></li>
                        <li className="follow__icon"><i className="fab fa-instagram"/></li>
                        <li className="follow__icon"><i className="fab fa-google-plus"/></li>
                    </ul>
                </div>
                <div className="category__list--container">
                    ...
                    <ul>
                        ...
                        <li><Link to="/products">All men</Link></li>
                        <li><Link to="/products">Платки</Link></li>
                        <li><Link to="/products">Постели</Link></li>
                        <li><Link to="/products">Сумочки</Link></li>
                        <li><Link to="/products">Золото</Link></li>
                    </ul>
                    <ul>
